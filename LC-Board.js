...
var displayDefects;
		 ...
		 var contrNames = ['Patricio P', 'Mario M', 'Franco B', 'Juan Barrionuevo', 'Jimena Barseghian', 'Alejandro Sosa', 'Guido C', 'Pablo Gimenez'];
		 var uids = ['ppage', 'mmunoz', 'fbostico', 'jbarrionuevo', 'jbarseghian', 'asosa', 'gcresta', 'pgimenez'];
