...
var displayDefects;
		 ...
		 var contrNames = ['Gaston Nieto', 'Franco B', 'Juan Barrionuevo', 'Merlin N', 'Jimena Barseghian', 'Gabriel Uanini', 'Alejandro Sosa', 'Guido C'];
		 var uids = ['gnieto', 'fbostico', 'jbarrionuevo', 'mnunez', 'jbarseghian', 'guanini', 'asosa', 'gcresta'];
